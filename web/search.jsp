<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="sh.data.servlet.Test" %>
            ...
            <div class="card">
              <div class="card-content grey">
                <span class="card-title">
                  <a href="http://www.jj.cn/" target="_blank" class="grey-text text-darken-4">
                                                【JJ斗地主官方下载】-斗地主,麻将等棋牌竞技平台
                  </a>
                </span>
                <p>J比赛，是全民娱乐的专业棋牌在线竞技平台,首创竞技比赛模式,免费赢奖品。提供斗地主,麻将,四国军棋,象棋,升级等棋牌游戏，同时还有捕鱼,桌球, 糖果连连消等休闲...</p>
              </div>
            </div>
          </div>
